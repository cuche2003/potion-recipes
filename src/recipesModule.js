...
import daiquiri from './daiquiri.jpg';
recipes.add(daiquiri, 'Daiquiri Potion', 
            '2.5 oz Aged Rum',
...
import martini from './martini.jpg';
recipes.add(martini, 'Tarmini Potion', 
...
recipes.add(gin, 'Gyn and Tonyc Potion', 
            '2 oz Gyn',
            '1 Lime Juice',
...
import kamikaze from './kamikaze.jpg';              
recipes.add(kamikaze, 'Kazekami Potion', 
            '1.5 oz Vodka',
            '1 oz Triple Sec',
